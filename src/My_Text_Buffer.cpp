...
*/
void My_Text_Buffer::text( const char *t ) {
...
*/
char * My_Text_Buffer::text_range( int start, int end ) {
  char * s;
...
*/
char My_Text_Buffer::character( int pos ) {
...
*/
void My_Text_Buffer::insert( int pos, const char *s ) {
  int nInserted;
...
*/
void My_Text_Buffer::replace( int start, int end, const char *s ) {
  const char * deletedText;
  int nInserted;
...
void My_Text_Buffer::remove( int start, int end ) {
  const char * deletedText;
...
void My_Text_Buffer::copy( My_Text_Buffer *fromBuf, int fromStart,
...
*/
void My_Text_Buffer::canUndo(char flag) {
  mCanUndo = flag;
}
...
*/
void My_Text_Buffer::insert_column( int column, int startPos, const char *s,
  ...
  if ( nDeleted != insertDeleted )
    Fl::error("My_Text_Buffer::insert_column(): internal consistency check ins1 failed");
...
*/
void My_Text_Buffer::overlay_rectangular( int startPos, int rectStart,
  ...
  if ( nDeleted != insertDeleted )
    Fl::error("My_Text_Buffer::overlay_rectangle(): internal consistency check ovly1 failed");
  call_modify_callbacks( lineStartPos, nDeleted, nInserted, 0, deletedText );
  free( (void *) deletedText );
  if ( charsInserted != NULL )
    * charsInserted = nInserted;
...
*/
void My_Text_Buffer::replace_rectangular( int start, int end, int rectStart,
  ...
  if ( insertDeleted != deleteInserted + linesPadded )
    Fl::error("My_Text_Buffer::replace_rectangular(): internal consistency check repl1 failed");
...
*/
void My_Text_Buffer::remove_rectangular( int start, int end, int rectStart,
    int rectEnd ) {
  const char * deletedText;
  int nInserted;
...
** rectEnd.
*/
void My_Text_Buffer::clear_rectangular( int start, int end, int rectStart,
                                        int rectEnd ) {
  int i, nLines;
  char *newlineString;
...
char * My_Text_Buffer::text_in_rectangle( int start, int end,
...
*/
void My_Text_Buffer::tab_distance( int tabDist ) {
  const char * deletedText;
...
void My_Text_Buffer::select( int start, int end ) {
  My_Text_Selection oldSelection = mPrimary;

  mPrimary.set( start, end );
  redisplay_selection( &oldSelection, &mPrimary );
}

void My_Text_Buffer::unselect() {
  My_Text_Selection oldSelection = mPrimary;
...
void My_Text_Buffer::select_rectangular( int start, int end, int rectStart,
    int rectEnd ) {
  My_Text_Selection oldSelection = mPrimary;
...
int My_Text_Buffer::selection_position( int *start, int *end
                                      ) {
...
char * My_Text_Buffer::selection_text() {
  return selection_text_( &mPrimary );
}

void My_Text_Buffer::remove_selection() {
  remove_selection_( &mPrimary );
}

void My_Text_Buffer::replace_selection( const char *s ) {
  replace_selection_( &mPrimary, s );
}

void My_Text_Buffer::secondary_select( int start, int end ) {
  My_Text_Selection oldSelection = mSecondary;

  mSecondary.set( start, end );
  redisplay_selection( &oldSelection, &mSecondary );
}

void My_Text_Buffer::secondary_unselect() {
  My_Text_Selection oldSelection = mSecondary;
...
void My_Text_Buffer::secondary_select_rectangular( int start, int end,
    int rectStart, int rectEnd ) {
  My_Text_Selection oldSelection = mSecondary;
...
int My_Text_Buffer::secondary_selection_position( int *start, int *end
                                      ) {
...
char * My_Text_Buffer::secondary_selection_text() {
  return selection_text_( &mSecondary );
}

void My_Text_Buffer::remove_secondary_selection() {
  remove_selection_( &mSecondary );
}

void My_Text_Buffer::replace_secondary_selection( const char *s ) {
  replace_selection_( &mSecondary, s );
}

void My_Text_Buffer::highlight( int start, int end ) {
  My_Text_Selection oldSelection = mHighlight;

  mHighlight.set( start, end );
  redisplay_selection( &oldSelection, &mHighlight );
}

void My_Text_Buffer::unhighlight() {
  My_Text_Selection oldSelection = mHighlight;
...
void My_Text_Buffer::highlight_rectangular( int start, int end,
    int rectStart, int rectEnd ) {
  My_Text_Selection oldSelection = mHighlight;
...
int My_Text_Buffer::highlight_position( int *start, int *end
                                      ) {
...
char * My_Text_Buffer::highlight_text() {
...
*/
void My_Text_Buffer::add_modify_callback( My_Text_Modify_Cb bufModifiedCB,
    void *cbArg ) {
  My_Text_Modify_Cb * newModifyProcs;
  void **newCBArgs;
  int i;

  newModifyProcs = new My_Text_Modify_Cb [ mNModifyProcs + 1 ];
...
void My_Text_Buffer::remove_modify_callback( My_Text_Modify_Cb bufModifiedCB,
    void *cbArg ) {
  int i, toRemove = -1;
  My_Text_Modify_Cb *newModifyProcs;
  void **newCBArgs;
  ...
  if ( toRemove == -1 ) {
    Fl::error("My_Text_Buffer::remove_modify_callback(): Can't find modify CB to remove");
    return;
  }
  ...
  newModifyProcs = new My_Text_Modify_Cb [ mNModifyProcs ];
...
*/
void My_Text_Buffer::add_predelete_callback(My_Text_Predelete_Cb bufPreDeleteCB,
	void *cbArg) {
    My_Text_Predelete_Cb *newPreDeleteProcs;
    void **newCBArgs;
    int i;
    
    newPreDeleteProcs = new My_Text_Predelete_Cb[ mNPredeleteProcs + 1 ];
...
void My_Text_Buffer::remove_predelete_callback(
   My_Text_Predelete_Cb bufPreDeleteCB, void *cbArg) {
    int i, toRemove = -1;
    My_Text_Predelete_Cb *newPreDeleteProcs;
    void **newCBArgs;
    ...
    if (toRemove == -1) {
    	Fl::error("My_Text_Buffer::remove_predelete_callback(): Can't find pre-delete CB to remove");
    	return;
    }
    ...
    newPreDeleteProcs = new My_Text_Predelete_Cb [ mNPredeleteProcs ];
...
*/
char * My_Text_Buffer::line_text( int pos ) {
...
*/
int My_Text_Buffer::line_start( int pos ) {
...
*/
int My_Text_Buffer::line_end( int pos ) {
  if ( !findchar_forward( pos, '\n', &pos ) )
    pos = mLength;
  return pos;
}

int My_Text_Buffer::word_start( int pos ) {
...
int My_Text_Buffer::word_end( int pos ) {
...
** equal in length to MY_TEXT_MAX_EXP_CHAR_LEN
*/
...
** equal in length to MY_TEXT_MAX_EXP_CHAR_LEN
*/
int My_Text_Buffer::expand_character( char c, int indent, char *outStr, int tabDist,
                                      char nullSubsChar ) {
  int i, nSpaces;
...
** to ignore).
*/
int My_Text_Buffer::character_width( char c, int indent, int tabDist, char nullSubsChar ) {
  /* Note, this code must parallel that in My_Text_Buffer::ExpandCharacter */
  if ( c == '\t' )
...
*/
int My_Text_Buffer::count_displayed_characters( int lineStartPos, int targetPos ) {
  int pos, charCount = 0;
...
*/
int My_Text_Buffer::skip_displayed_characters( int lineStartPos, int nChars ) {
  int pos, charCount = 0;
  char c;
...
*/
int My_Text_Buffer::count_lines( int startPos, int endPos ) {
...
*/
int My_Text_Buffer::skip_lines( int startPos, int nLines ) {
  int pos, gapLen = mGapEnd - mGapStart;
  int lineCount = 0;
...
** the line
*/
int My_Text_Buffer::rewind_lines( int startPos, int nLines ) {
  int pos, gapLen = mGapEnd - mGapStart;
  int lineCount = -1;
...
*/
int My_Text_Buffer::search_forward( int startPos, const char *searchString,
...
** returns 1 if found, 0 if not.
*/
int My_Text_Buffer::search_backward( int startPos, const char *searchString,
                                     int *foundPos, int matchCase )
{
  if (!searchString) return 0;
  int bp;
...
** returns 1 if found, 0 if not.
*/
int My_Text_Buffer::findchars_forward( int startPos, const char *searchChars,
                                    int *foundPos ) {
  int pos, gapLen = mGapEnd - mGapStart;
  const char *c;
...
** returns 1 if found, 0 if not.
*/
int My_Text_Buffer::findchars_backward( int startPos, const char *searchChars,
                                     int *foundPos ) {
  int pos, gapLen = mGapEnd - mGapStart;
  const char *c;
...
*/
int My_Text_Buffer::substitute_null_characters( char *string, int len ) {
  char histogram[ 256 ];
...
*/
int My_Text_Buffer::insert_( int pos, const char *s ) {
...
** the delete).
*/
void My_Text_Buffer::remove_( int start, int end ) {
...
*/
void My_Text_Buffer::insert_column_( int column, int startPos, const char *insText,
  ...
  /* Allocate a buffer for the replacement string large enough to hold
     ...
     area, as well as per line: 1) an additional 2*MY_TEXT_MAX_EXP_CHAR_LEN
  ...
  outStr = (char *)malloc( expReplLen + expInsLen +
                           nLines * ( column + insWidth + MY_TEXT_MAX_EXP_CHAR_LEN ) + 1 );
...
*/
void My_Text_Buffer::remove_rectangular_( int start, int end, int rectStart,
  ...
  /* allocate a buffer for the replacement string large enough to hold
     possibly expanded tabs as well as an additional  MY_TEXT_MAX_EXP_CHAR_LEN * 2
  ...
  free( (void *) s );
  free( (void *) expText );
  outStr = (char *)malloc( len + nLines * MY_TEXT_MAX_EXP_CHAR_LEN * 2 + 1 );
...
*/
void My_Text_Buffer::overlay_rectangular_(int startPos, int rectStart,
  ...
  /* Allocate a buffer for the replacement string large enough to hold
     ...
     an additional 2*MY_TEXT_MAX_EXP_CHAR_LEN characters for padding where tabs
  ...
  outStr = (char *)malloc( end - start + expInsLen +
                           nLines * ( rectEnd + MY_TEXT_MAX_EXP_CHAR_LEN ) + 1 );
...
static void insertColInLine( const char *line, char *insLine, int column, int insWidth,
  ...
  for ( linePtr = line; *linePtr != '\0'; linePtr++ ) {
    len = My_Text_Buffer::character_width( *linePtr, indent, tabDist, nullSubsChar );
  ...
  if ( *insLine != '\0' ) {
    ...
    for ( c = retabbedStr; *c != '\0'; c++ ) {
      *outPtr++ = *c;
      len = My_Text_Buffer::character_width( *c, indent, tabDist, nullSubsChar );
      indent += len;
    }
...
static void deleteRectFromLine( const char *line, int rectStart, int rectEnd,
  ...
  for ( ; *c != '\0' && indent < rectEnd; c++ )
    indent += My_Text_Buffer::character_width( *c, indent, tabDist, nullSubsChar );
...
static void overlayRectInLine( const char *line, char *insLine, int rectStart,
  ...
  for ( linePtr = line; *linePtr != '\0'; linePtr++ ) {
    len = My_Text_Buffer::character_width( *linePtr, inIndent, tabDist, nullSubsChar );
  ...
  for ( ; *linePtr != '\0'; linePtr++ ) {
    inIndent += My_Text_Buffer::character_width( *linePtr, inIndent, tabDist, nullSubsChar );
    if ( inIndent >= rectEnd ) {
      linePtr++;
  ...
  if ( *insLine != '\0' ) {
    ...
    for ( c = retabbedStr; *c != '\0'; c++ ) {
      *outPtr++ = *c;
      len = My_Text_Buffer::character_width( *c, outIndent, tabDist, nullSubsChar );
      outIndent += len;
    }
    free( (void *) retabbedStr );
  }
...
void My_Text_Selection::set( int startpos, int endpos ) {
...
void My_Text_Selection::set_rectangular( int startpos, int endpos,
    int rectStart, int rectEnd ) {
...
int My_Text_Selection::position( int *startpos, int *endpos ) {
  if ( !mSelected )
    return 0;
  *startpos = mStart;
  *endpos = mEnd;
...
** the My_Text_Selection.
*/
int My_Text_Selection::includes(int pos, int lineStartPos, int dispIndex) {
  return selected() &&
...
char * My_Text_Buffer::selection_text_( My_Text_Selection *sel ) {
...
void My_Text_Buffer::remove_selection_( My_Text_Selection *sel ) {
  int start, end;
...
void My_Text_Buffer::replace_selection_( My_Text_Selection *sel, const char *s ) {
  int start, end, isRect, rectStart, rectEnd;
  My_Text_Selection oldSelection = *sel;
...
static void addPadding( char *string, int startIndent, int toIndent,
  ...
  if ( useTabs ) {
    while ( indent < toIndent ) {
      len = My_Text_Buffer::character_width( '\t', indent, tabDist, nullSubsChar );
...
*/
void My_Text_Buffer::call_modify_callbacks( int pos, int nDeleted,
...
*/
void My_Text_Buffer::call_predelete_callbacks(int pos, int nDeleted) {
    int i;
...
*/
void My_Text_Buffer::redisplay_selection( My_Text_Selection *oldSelection,
    My_Text_Selection *newSelection ) {
...
void My_Text_Buffer::move_gap( int pos ) {
...
*/
void My_Text_Buffer::reallocate_with_gap( int newGapStart, int newGapLen ) {
  char * newBuf;
  int newGapEnd;
...
*/
void My_Text_Buffer::update_selections( int pos, int nDeleted,
                                        int nInserted ) {
...
*/
void My_Text_Selection::update( int pos, int nDeleted,
                                int nInserted ) {
...
*/
int My_Text_Buffer::findchar_forward( int startPos, char searchChar,
                                    int *foundPos ) {
  int pos, gapLen = mGapEnd - mGapStart;
...
** count lines quickly, hence searching for a single character: newline)
*/
int My_Text_Buffer::findchar_backward( int startPos, char searchChar,
                                     int *foundPos ) {
  int pos, gapLen = mGapEnd - mGapStart;
...
static int textWidth( const char *text, int tabDist, char nullSubsChar ) {
  ...
  for ( c = text; *c != '\0'; c++ ) {
    if ( *c == '\n' ) {
      ...
      width += My_Text_Buffer::character_width( *c, width, tabDist, nullSubsChar );
  }
  if ( width > maxWidth )
    return width;
  return maxWidth;
...
*/
void My_Text_Buffer::rectangular_selection_boundaries( int lineStartPos,
  ...
  for ( pos = lineStartPos; pos < mLength; pos++ ) {
    ...
    if ( c == '\n' )
      break;
    width = My_Text_Buffer::character_width( c, indent, mTabDist, mNullSubsChar );
...
static char *expandTabs( const char *text, int startIndent, int tabDist,
  ...
  for ( c = text; *c != '\0'; c++ ) {
    if ( *c == '\t' ) {
      len = My_Text_Buffer::expand_character( *c, indent, outPtr, tabDist, nullSubsChar );
      outPtr += len;
      indent += len;
    } else if ( *c == '\n' ) {
      indent = startIndent;
...
static char *unexpandTabs( char *text, int startIndent, int tabDist,
                           char nullSubsChar, int *newLen ) {
  char * outStr, *outPtr, *c, expandedChar[ MY_TEXT_MAX_EXP_CHAR_LEN ];
  int indent, len;
  ...
  for ( c = text; *c != '\0'; ) {
    if ( *c == ' ' ) {
      len = My_Text_Buffer::expand_character( '\t', indent, expandedChar, tabDist,
                                              nullSubsChar );
...
int
My_Text_Buffer::insertfile(const char *file, int pos, int buflen) {
  FILE *fp;  int r;
...
int
My_Text_Buffer::outputfile(const char *file, int start, int end, int buflen) {
  FILE *fp;
